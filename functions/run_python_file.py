...
def run_python_file(working_directory: str, file_path: str, args: list[str] | None = None) -> str:
    try:
        ...
        result = subprocess.run(command, cwd=abs_working_directory, capture_output=True, text=True, timeout=30)
        output_parts = []
...
schema_run_python_file = {
    ...
    "function": {
        ...
        "description": "Execute a Python script, optionally with command-line arguments.",
        "parameters": {
            "type": "object",
            "properties": {
                "file_path": {
                    "type": "string",
                    "description": "Relative path of the Python script to execute.",
                },
                "args": {
                    "type": "array",
